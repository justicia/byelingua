...
def build_report(summary: dict, *, existing_production_venues: int = 9) -> dict:
    ...
    return {
        ...
        "HERMES_ATTEMPTED": summary.get("hermes_attempted", 0),
        "HERMES_NEW_FACTS_SUCCEEDED": summary.get("hermes_new_facts_succeeded", 0),
        "HERMES_REUSED": summary.get("hermes_reused", 0),
        "HERMES_FAILED": summary.get("hermes_failed", 0),
        "HERMES_TIMED_OUT": summary.get("hermes_timed_out", 0),
