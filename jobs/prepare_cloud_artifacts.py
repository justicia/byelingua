...
def _safe_summary(summary: dict[str, Any], output_dir: Path) -> dict[str, Any]:
    ...
    return {
        ...
        "existing_production": {
            "records_loaded": _int((summary.get("existing_production") or {}).get("records_loaded")),
            "events_scoped": _int((summary.get("existing_production") or {}).get("events_scoped")),
            "events_matched": _int((summary.get("existing_production") or {}).get("events_matched")),
            "unmatched_existing": _int((summary.get("existing_production") or {}).get("unmatched_existing")),
            "unmatched_staged": _int((summary.get("existing_production") or {}).get("unmatched_staged")),
            "ambiguous": _int((summary.get("existing_production") or {}).get("ambiguous")),
        },
        "counts": {
